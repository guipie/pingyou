...
export type ModelMode = 'standard' | 'standard-feibi' | 'standard-keli' | 'standard-wendi' | 'keyboard' | 'gamepad' | 'model3d'
...
export const useModelStore = defineStore('model', () => {
  ...
  const init = async () => {
    ...
    const modesLive2d: ModelMode[] = ['gamepad', 'keyboard', 'standard', 'standard-feibi', 'standard-keli', 'standard-wendi']
