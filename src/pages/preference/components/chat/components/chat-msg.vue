...
<template>
  ...
  >
    ...
    >
      ...
      >
        <div
          class="wechat-bubble wechat-bubble-user max-w-[62%] whitespace-pre-wrap px-3.5 py-2.5 text-3.5 leading-6 shadow-sm"
        >
          {{ item.question }}
        </div>
        <div>
      ...
      >
        ...
        <div
          class="wechat-bubble wechat-bubble-pet mb-20px max-w-[70%] whitespace-pre-wrap bg-[--ant-color-fill-quaternary] px-2.5 pt-3.5 text-3.5 leading-6 shadow-sm"
        >
          <VueMarkdown
