...
<template>
  ...
  >
    ...
    <canvas
      id="live2dCanvas"
      :class="{ 'opacity-0 w-0 h-0': currentEngine !== 'live2d' }"
      :style="currentEngine !== 'live2d' ? 'width:0px;height:0px' : ''"
    />
    <canvas
      id="model3dCanvas"
      :class="{ 'opacity-0  w-0 h-0': currentEngine !== '3d' }"
      :style="currentEngine !== '3d' ? 'width:0px;height:0px' : ''"
    />
    <img
